...
const SavedTrips = () => {
    ...
    useEffect(() => {
        const fetchTrips = async () => {
            try {
                const res = await axios.get('https://smart-travel-ai-backend.onrender.com/api/.../trips');
                setTrips(res.data);
            } catch (err) {
                console.error(err);
            }
    ...
    const handleDelete = async (id, e) => {
        ...
        if (window.confirm("Are you sure you want to delete this trip?")) {
            try {
                await axios.delete(`https://smart-travel-ai-backend.onrender.com/api/.../trips/${id}`);
