...
const Explorer = () => {
    ...
    useEffect(() => {
        const fetchDestinations = async () => {
            setLoading(true);
            try {
                let url = 'https://smart-travel-ai-backend.onrender.com/api/.../destinations';
                ...
                if (q) {
                    url = `https://smart-travel-ai-backend.onrender.com/api/.../destinations/search?q=${encodeURIComponent(q)}`;
